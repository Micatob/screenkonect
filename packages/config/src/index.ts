...
const SessionPolicySchema = z.object({
  ...
  idle_timeout_minutes: z.number().min(1).max(120).default(40),
  one_time_link_usage: z.boolean().default(false),
  consent_timeout_ms: z.number().min(1000).max(7200000).default(2700000),
...
const SecurityConfigSchema = z.object({
  ...
  token_expiry_ms: z.number().min(60000).max(7200000).default(2700000),
